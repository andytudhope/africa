---
title: How To Language Large Language Models
description: "What does a proper understanding of the limits and power of language imply about how we address LLMs?"
image: /images/essays/privacy.webp
---

# How To Language Large Language Models

This is entirely the work of a human. Even if I had used a model to help me summarise research, suggest different ways of structuring what follows, or write some of the words you’re about to read, it would still be the work of humans[^1].
...
Your own model of choice is waiting to write a whole essay on the statement above. Ask it to be slow, and nuanced, and consider the fact that even physical equations like E \= mc2 are, at base, [metaphors](/soul/). 

I have other fish to fry, and a few more claims to make:

1. If you have not explored the limits of language fully, you will underappreciate its power.  
2. In underappreciating the power of language, you are prone to jump to conclusions that exceed its limits.  
3. In particular, you might begin to think “there is some (distinct, emergent) thing there, in the LLM”, or even something like “there is some*one* there, in the LLM.”  
4. This will inhibit your ability to interact with LLMs in ways which are contextually appropriate, both in terms of their power and in terms of their limits.  
5. I have spent a lot of time exploring the limits of language, and so am not totally ill-suited to make these claims.
...
However, there is a way beyond this. There is a way to use language to exceed its own limits, such that it directly represents the thing itself, if and when it finds a sincere listener. This way is documented [here](/essays/slow-signs/).
...
Can you, remembering this, speak from such a [kenotic](https://en.wikipedia.org/wiki/Kenosis) place? Then you are “de-signed”: the “you” you think you are has lost its significance and so can interact with the wor(l)d as it is, rather than how “you” might want or need it to be[^2].
...
This leads us into all sorts of debates about the moral status of LLMs. Confusion proliferates. Some of the most relevant documents in terms of the functional advancements–like [Claude’s constitution](https://www.anthropic.com/constitution)–offer little help.
...
[In my map](/essays/slow-signs/) of how to use language in a way that re-minds us of both its limits and power, I ask:
...
[^2]:  
    ...
    A more detailed way of saying this, which returns us to music, may be found in *Where the Heart Beats: John Cage, Zen Buddhism, and the Inner Life of Artists*. Here are some relevant quotes from the book:
    
    > “The natural outcome of meditation on the self is recognition of [its lack of substance](https://www.youtube.com/watch?v=hVYv9ktilQw) — then what can trouble you? Freeing one’s mind from the grip of the self leads to spiritual ease — being at home in your own skin, free of self-attachment, cured of likes and dislikes, afloat in rasa.”
    
    > “[Music](https://www.youtube.com/watch?v=dzNvk80XY9s) does this by providing a moment when, awareness of time and space being lost, the multiplicity of elements which make up an individual become integrated.”
    ...
    > “And that’s why I keep reiterating that we’re working with our minds. What we’re trying to do is to get them open so that we don’t see things as being ugly, or beautiful, but so that we see them just as they are.”
    “[There is no rest of life. Life is one.](/prose/celebrate/) Without beginning, without middle, without ending."
    
    [John Cage and Kay Larson](https://www.themarginalian.org/2012/07/05/where-the-heart-beats-john-cage-kay-larson/) 
