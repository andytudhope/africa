...
1. Using tokens as votes does increase the supply if projects need to sell those tokens to fund their work. My sense is that this is (a) balanced somewhat by increased demand for a token with increasingly demonstrated utility and (b) by the fact that projects can likely fund a lot of their work with the token itself, as contibutors have strong incentives to hold "equity" in the form of tokens associated with the stuff they're actually working on.
